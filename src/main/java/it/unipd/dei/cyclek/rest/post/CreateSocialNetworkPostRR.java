 ...
 * @since 1.00
 */
public class CreateSocialNetworkPostRR extends AbstractRR {
     ...
     */
    public CreateSocialNetworkPostRR(final HttpServletRequest req, final HttpServletResponse res, Connection con) {
